    ...
    <div className="adminOrdDis">
      ...
      <div className="adminOrdDis__products">
        ...
        {products.map((product) => (
          <div key={product._id} className={`product ${checkedProducts.includes(product._id) ? 'checked' : ''}`}>
          ...
          <button name="checked" onClick={() => toggleCheck(product._id)}>
          ...
          <button name="check" onClick={() => toggleCheck(product._id)}>
