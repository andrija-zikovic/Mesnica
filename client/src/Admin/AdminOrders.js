        ...
        <div className="adminOrd">
            ...
            <table className="adminOrd__table">
                ...
                <tbody className="adminOrd__tbody">
                    {adminOrd.slice().reverse().map((orderData, index) => (
                        <React.Fragment key={orderData._id}>
                        <tr onClick={() => toggleVisibility(orderData._id)}>
                          <td>{orderData.num}</td>
                        ...
                        {visibleOrders.includes(orderData._id) && (
                          <tr>
                            <td colSpan="4">
                              <AdminOrder orderData={orderData} toggleVisibility={() => toggleVisibility(orderData._id)}/>
                            </td>
                          </tr>
                        )}
                      </React.Fragment>
